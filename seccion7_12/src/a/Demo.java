...
public class Demo {
    ...
    public static void main(String[] args) {
        /* Persona es abstracta,Esto causara un error de compilacion
        ...
        */        
        ...
        System.out.println("------");
        System.out.println("Estudiante 2 "+estudiante1.correr(7));
        System.out.println("Estudiante 2 "+estudiante2.correr(5));
    }    
}
