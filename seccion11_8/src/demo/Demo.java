...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        while(salir=="n"){
            ...
            System.out.println("3-Obtener libro existente");
            ...
            switch(opcion){
                case "1":
                    ...
                    System.out.println("Introduzca la edicion del libro");
                    try {
                ...
                case "2":
                    ...
                    librodbe.actualizar(salir, libro);
                    break;
                case "3":
                    String isbn;
                    ...
                    System.out.println("Introduza el ISBN del libro");
                    isbn=scb.nextLine();
                    ...
                    break;
                case "4":
                    LibroDb todo=new LibroDb();
                    ArrayList<Libro> libros=todo.listado();
                ...
                case "5":
                    ...
                    System.out.println("Ingrese el ISBN del libro que desea borrat");
